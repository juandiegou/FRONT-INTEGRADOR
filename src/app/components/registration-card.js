...
const RegistratonCard = ({registration, amount}) => {
                    ...
                    <div className=" w-full md:w-1/2 lg:w-1/3 p-2">
                       ...
                       <div className="p-0">
                            <div className="grid gap-x-1 gap-y-4 grid-cols-3">
                                <div className="w-1/2 md:w-4/5 lg:w-3/4 ml-4">
                                    <p className="text-gray-700">Valor:{registration.amount? "$"+registration.amount:"$"+amount}</p>
                                </div>
                                <div className="w-1/2 md:w-4/5 lg:w-3/4 ml-4">
                                    {
                                        registration?.student&&(
                                            <div className="w-1/2 md:w-1/5 lg:w-1/4">
                                                <div className="flex justify-center">
                                                    <StudentCard key={"student-Card-"+`${registration.student.id}`}  student={registration.student} />
                                                </div>  
                                            </div>
